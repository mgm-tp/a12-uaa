...
public class DocumentChanges extends PropertyChange<IDocument> {

	private List<DocumentPropertyChange<?>> propertyChanges;

	private transient IDocument left;
	private transient IDocument right;

	public DocumentChanges(PropertyChangeMetadata propertyChangeMetadata, List<DocumentPropertyChange<?>> propertyChanges, IDocument left, IDocument right) {
