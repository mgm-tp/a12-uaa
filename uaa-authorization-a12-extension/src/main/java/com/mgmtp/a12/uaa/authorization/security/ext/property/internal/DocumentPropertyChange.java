...
public class DocumentPropertyChange<T> extends PropertyChange<T> {

	private transient final T left;
	private transient final T right;

	public DocumentPropertyChange(PropertyChangeMetadata propertyChangeMetadata, T left, T right) {
