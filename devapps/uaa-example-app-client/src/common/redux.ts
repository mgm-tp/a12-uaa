...
export function getComposeWithDevTools(): ReduxDevToolsCompose {
...
export function createComposeEnhancer(): ComposeEnhancer {
  return ((...enhancers: unknown[]) =>
    getComposeWithDevTools()(
      ...(enhancers as Parameters<typeof compose>),
    )) as ComposeEnhancer;
}

export const withReduxDevtool = <T extends A12ApplicationConfig>(
  cfg: T,
): T => ({
  ...cfg,
