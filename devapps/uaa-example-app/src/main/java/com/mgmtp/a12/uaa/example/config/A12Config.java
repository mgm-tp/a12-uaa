...
@Configuration
public class A12Config {
	@Bean
	public DocumentModelServiceFactory documentModelServiceFactory() {
		return new DocumentModelServiceFactory();
	}

	@Bean
	public IDocumentModelSerializer documentModelSerializer(DocumentModelServiceFactory documentServiceFactory) {
		return documentServiceFactory.createDocumentModelSerializer();
	}

	@Bean
	public DocumentServiceFactory documentServiceFactory(IDocumentModelResolver documentModelResolver) {
		return new DocumentServiceFactory(documentModelResolver);
	}

	@Bean
	public IDocumentV2Serializer documentSerializer(DocumentServiceFactory documentServiceFactory) {
