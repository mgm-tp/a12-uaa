...
public class BasicOauth2ClaimsExtractor implements Oauth2ClaimsExtractor {
	...
	public UserDetails extractClaims(Jwt token) {
		...
		return new BasicPrincipal(userName, "****", authorities, extendedPrincipalDataLoader.loadExtendedPrincipalData(userName));
	}
