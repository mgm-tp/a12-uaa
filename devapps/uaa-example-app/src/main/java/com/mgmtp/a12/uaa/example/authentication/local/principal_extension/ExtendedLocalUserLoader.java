 ...
 */
package com.mgmtp.a12.uaa.example.authentication.local.principal_extension;
...
public class ExtendedLocalUserLoader<T extends LocalUser> implements LocalUserLoader<T> {
	...
	private static final Logger LOGGER = LoggerFactory.getLogger(ExtendedLocalUserLoader.class);

	private final ObjectMapper usersDeserializer = new ObjectMapper(new YAMLFactory());

	private Class<T> userType;

	public ExtendedLocalUserLoader(Class<T> userType) {
