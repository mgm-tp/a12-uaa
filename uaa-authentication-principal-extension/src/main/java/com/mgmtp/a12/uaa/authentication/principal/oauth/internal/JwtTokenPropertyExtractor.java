...
public class JwtTokenPropertyExtractor implements PropertyExtractor<Jwt> {

	@Override
	public String extractProperty(AbstractExtendedPrincipal<?> user, Jwt payload, String propertyName) {
		return payload.getClaimAsString(propertyName);
	}
