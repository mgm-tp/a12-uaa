...
public class CertificateAutoConfiguration {
	...
	public CertificateConverter uaaCertificateConverter() {
		return new CertificatePrincipalConverter(authenticationUserProperties.getCertificateConfig().getUsernameField(),
			authenticationUserProperties.getCertificateConfig().getUserRoleField());
	}
