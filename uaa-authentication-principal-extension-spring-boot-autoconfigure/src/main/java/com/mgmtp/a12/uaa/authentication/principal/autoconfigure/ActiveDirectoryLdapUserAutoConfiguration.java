...
import com.mgmtp.a12.uaa.authentication.principal.ldap.internal.LdapPrincipalConverter;
...
public class ActiveDirectoryLdapUserAutoConfiguration {

	@Bean
	@ConditionalOnMissingBean(UserDetailsContextMapper.class)
	public UserDetailsContextMapper createLdapUserConverter() {
		return new LdapPrincipalConverter();
	}
