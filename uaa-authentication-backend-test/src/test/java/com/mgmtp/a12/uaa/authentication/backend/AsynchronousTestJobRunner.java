...
@Component
public class AsynchronousTestJobRunner {
	...
	public void executeJob() throws InterruptedException, ExecutionException {
		executeInThread(() -> testService.executeFunction());
	}
	...
	private void executeInThread(Runnable function) throws InterruptedException, ExecutionException {
		ExecutorService executorService = Executors.newFixedThreadPool(5);
		CompletableFuture<Void> completableFuture = CompletableFuture.runAsync(() -> function.run(), executorService);
