...
import { LanguageService, TextDocument } from "vscode-json-languageservice";

import { runSafeAsync } from "../../utils/runner.js";
import { getJSONDocument } from "../../utils/utils.js";
import { RuntimeEnvironment } from "../../interfaces/server.js";

export const onHoverHandler =
	(
	...
	(
		...
		return runSafeAsync(
			...
			async () => {
				...
				if (document) {
					const jsonDocument = getJSONDocument(document, languageService);
