...
public class UAAAuthenticationFilter extends AbstractAuthenticationProcessingFilter {
	...
	public Authentication attemptAuthentication(HttpServletRequest request, HttpServletResponse response)
		...
		LoginRequest loginRequest = standardJsonHandler.convertFromJson(body, LoginRequest.class);
		String username = "";
		String password = "";
		...
		TypedUsernamePasswordAuthenticationToken<?> authRequest = new TypedUsernamePasswordAuthenticationToken<Void>(username, password, type);
