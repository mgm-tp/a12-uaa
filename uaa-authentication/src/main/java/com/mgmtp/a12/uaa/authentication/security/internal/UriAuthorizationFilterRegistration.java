...
public class UriAuthorizationFilterRegistration {
	private final List<FilterRegistration> filterRegistrations;

	public UriAuthorizationFilterRegistration(List<FilterRegistration> filterRegistrations) {
		this.filterRegistrations = filterRegistrations;
	}

	public List<FilterRegistration> getFilterRegistrations() {
