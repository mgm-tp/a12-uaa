...
public class DelegatingPathFilter extends AbstractPathFilter {

	private static final Logger LOGGER = LoggerFactory.getLogger(DelegatingPathFilter.class);
	...
	protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws ServletException, IOException {
		LOGGER.debug("Delegating to filter {} for path {}", delegatedFilter.getClass().getName(), request.getRequestURI());
		delegatedFilter.doFilter(request, response, filterChain);
	}
