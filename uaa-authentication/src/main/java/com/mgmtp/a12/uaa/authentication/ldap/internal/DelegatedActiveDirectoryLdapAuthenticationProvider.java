...
public class DelegatedActiveDirectoryLdapAuthenticationProvider implements AuthenticationProvider {

	private AuthenticationProvider delegate;

	public DelegatedActiveDirectoryLdapAuthenticationProvider(AuthenticationProvider delegate) {
	...
	public Authentication authenticate(Authentication authentication) throws AuthenticationException {
		...
		if (localToken.getType() != AuthenticationType.ACTIVE_DIRECTORY_LDAP) {
			return null;
		}
