...
/**
 * Extract assertions from SAML response and create user principal out of it.  
 *
 */
public interface SamlAssertionExtractor {
	 ...
	 * <p>
	 * NOTE: Please set the {@link SamlPrincipal#getRelyingPartyRegistrationId()} otherwise logout request can't be processed.
	 ...
	 */
	SamlPrincipal extractAssertion(ResponseToken samlResponse);
