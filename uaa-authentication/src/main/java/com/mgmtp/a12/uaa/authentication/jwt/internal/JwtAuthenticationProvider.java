...
public class JwtAuthenticationProvider implements AuthenticationProvider {
	...
	public JwtAuthenticationProvider(PrincipalCreator<? extends UserDetails> jwtTokenPrincipalCreator, JwtTokenVerifier jwtTokenVerifier) {
		this.jwtTokenPrincipalCreator = jwtTokenPrincipalCreator;
	...
	public Authentication authenticate(Authentication authentication) throws AuthenticationException {
		...
		JwtTokenData tokenData = jwtTokenVerifier.unpackToken(jwtToken.getAccessToken());
		UserDetails principal = jwtTokenPrincipalCreator.createPrincipal(tokenData);
		if (principal != null) {
