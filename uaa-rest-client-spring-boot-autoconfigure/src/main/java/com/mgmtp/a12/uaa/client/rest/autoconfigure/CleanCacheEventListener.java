...
import com.mgmtp.a12.uaa.client.rest.cache.CacheFlushEvent;
...
public class CleanCacheEventListener {
	...
	@EventListener
	public void onFlush(CacheFlushEvent event) {
		cacheService.ifPresent(service -> service.flush(event.getEndpointPath()));
	}
}
