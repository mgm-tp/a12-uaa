...
This is the documentation report of performance testing from results of Benchmark.

=== Authentication

[format="csv",options="header"]
|===
include::../authentication/target/benchmark.csv[]
|===
...
[format="csv",options="header"]
|===
include::../authorization/target/benchmark.csv[]
|===

=== Authorization A12 Extend

[format="csv",options="header"]
|===
include::../uaa-authorization-a12-extension/target/benchmark.csv[]
|===
