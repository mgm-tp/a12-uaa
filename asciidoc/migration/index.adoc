...
NOTE: UAA provides https://docs.openrewrite.org[OpenRewrite recipes] for automatic migration of breaking changes.
Please read link:/docs/overall/migration_guide/index.html#_usage_of_openrewrite_for_backend_components[how to apply OpenRewrite recipes] in A12 backend components.
