...
----
+
NOTE: Use `uaa-authentication-client-codemod` with recipe `top-level-imports` to migrate automatically.
+
[source,shell]
----
npx @com.mgmtp.a12.uaa/uaa-authentication-client-codemod top-level-imports <path-to-tsconfig>
----
