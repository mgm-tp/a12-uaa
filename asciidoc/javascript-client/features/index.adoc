...
////
=== Features
include::integrate_with_uaa.adoc[]

include::self_configure.adoc[]

include::restore_authentication.adoc[]

include::renew_token.adoc[]

include::localization.adoc[]

include::uaa_components_customization.adoc[]

include::service_worker_for_token_injection.adoc[]