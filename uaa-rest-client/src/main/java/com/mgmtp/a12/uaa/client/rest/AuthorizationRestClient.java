...
public class AuthorizationRestClient {
	...
	private static String[] URL = { "uaa-authorization", "reloadRules" };

	private RestGetConnector getConnector;
	private UrlBuilderSupport urlBuilderSupport;

	public AuthorizationRestClient(String baseUrl, RestGetConnector getConnector) {
		this.getConnector = getConnector;
		this.urlBuilderSupport = UrlBuilderSupport.withBaseUrl(baseUrl, URL);
	}
