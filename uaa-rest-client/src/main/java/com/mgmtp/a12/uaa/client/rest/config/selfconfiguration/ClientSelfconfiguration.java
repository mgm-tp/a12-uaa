...
public class ClientSelfconfiguration {
	...
	private LdapConfiguration activeDirectoryLdap;
	...
	public LdapConfiguration getActiveDirectoryLdap() {
		return activeDirectoryLdap;
	}

	public void setActiveDirectoryLdap(LdapConfiguration activeDirectoryLdap) {
	...
	public String toString() {
		return "ClientSelfconfiguration{" +
			...
			", local=" + local +
			", activeDirectoryLdap=" + activeDirectoryLdap +
			", saml=" + saml +
			", oidc=" + oidc +
			", tokens=" + tokens +
			", cache=" + cache +
