...
public class SamlConfiguration extends LocalConfiguration {
	private SsoConfiguration ssoConfiguration;
	private HttpMethod logoutMethod;
	...
	public String toString() {
		return "SamlConfiguration [ssoConfiguration=" + ssoConfiguration + ", logoutMethod=" + logoutMethod + "]";
	}
