 ...
 */
package com.mgmtp.a12.uaa.client.rest.auth.internal.delegated;
...
public class AuthorizationDataHolder {
	...
	private static AuthorizationDataStore credentialsContext = new ThreadLocalAuthorizationDataStore();

	public static AuthorizationDataStore getCredentialContext() {
