...
public class WebClientFactoryTest {
	...
	void createWebClientTest() {
		...
		Assertions.assertTrue(webClient.getOptions().isRedirectEnabled());
		...
		webClient.getCssErrorHandler().error(null);
		webClient.getCssErrorHandler().fatalError(null);
		webClient.getCssErrorHandler().warning(null);
