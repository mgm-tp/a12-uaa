...
public class RequestAuthorizationDataLocatorTest {

	private RequestAuthorizationDataLocator requestAuthorizationDataLocator = new RequestAuthorizationDataLocator(HttpHeaders.AUTHORIZATION);
	private MockHttpServletRequest request = new MockHttpServletRequest();
	private String baseUrl = "http://localhost:8080";
	private String authToken = "token data";

	@Test
	void convertTest() {
		request.addHeader(HttpHeaders.COOKIE, "JSESSIONID=\"sessionData\"");
