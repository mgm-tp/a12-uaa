...
public class BenchmarkAuthorizationRunner {
	public static void main(String[] args) throws RunnerException {
		File targetDir = new File(BenchmarkAuthorizationRunner.class.getProtectionDomain().getCodeSource().getLocation().getPath()).getParentFile();
