...
public final class ChildrenBuilder {
	...
	public static ChildrenBuilder aChildren() {
		return new ChildrenBuilder();
	}

	public ChildrenBuilder withName(String name) {
		this.name = name;
		return this;
	}

	public ChildrenBuilder withAge(Integer age) {
		this.age = age;
		return this;
	}

	public ChildrenBuilder withDescription(String description) {
