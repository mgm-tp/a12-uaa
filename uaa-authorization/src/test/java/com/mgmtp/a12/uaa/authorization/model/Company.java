...
//	parameters = @ParamDef(name = "country_code", type = "string"))
//@Filters({
...
//	@JoinColumn(name = "company_id")
	...
	public String toString() {
		...
		builder.append("Company [id=").append(id).append(", owner=").append(owner).append(", name=").append(name).append(", countryCode=")
