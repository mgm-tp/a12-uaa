...
public class ExpressionTypeKeyword extends AbstractKeyword {

	public ExpressionTypeKeyword() {
	...
	public JsonValidator newValidator(SchemaLocation schemaLocation, JsonNodePath evaluationPath, JsonNode schemaNode, JsonSchema parentSchema,
		...
		return new ExpressionTypeValidator(schemaLocation, evaluationPath, schemaNode, parentSchema, this, validationContext, false);
	}
