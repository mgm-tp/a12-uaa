...
public interface AuthorizationDefinitionRepository {

	Set<Permission> getPermissionsByScope(String scopeName);

	Optional<Policy> getPolicyByName(String policyName);

	Optional<RepositoryPolicy> getRepositoryPolicyByName(String policyName);

	Set<PropertyPermission> getPropertyPermission();

	Set<Rights> getPropertyRightsByNames(Set<String> names);
