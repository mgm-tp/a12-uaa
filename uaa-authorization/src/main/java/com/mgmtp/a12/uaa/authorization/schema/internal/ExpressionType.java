...
public enum ExpressionType {
	NONE("none"),
	UAA_EXPRESSION("UAAExpression"),
	SPRING_EXPRESSION_LANGUAGE("SpEL");

	private final String value;

	private static final Map<String, ExpressionType> CONSTANTS = new HashMap<>();

	static {
		for (ExpressionType c : values()) {
