...
public class LocationTextNode extends TextNode implements LocationProvider {
	private final LocationDetails locationDetails;

	public LocationTextNode(String value, JsonLocation tokenLocation, JsonLocation currentLocation) {
		super(value);
