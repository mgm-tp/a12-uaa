...
public class ObjectResolver {
	...
	public static  Object resolveDataObject(Object domainObject) {
		Object plainObject = getUltimateTargetObject(domainObject);
		if (plainObject instanceof Optional<?> optional) {
			plainObject = optional.orElse(null);
		}
		return plainObject;
